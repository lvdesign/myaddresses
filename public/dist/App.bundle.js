...
function loadPlaces(map) {
  var lat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 48.85;
  var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 2.27;
  axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/stores/near?lat=".concat(lat, "&lng=").concat(lng)).then(function (res) {
    ...
    var bounds = new google.maps.LatLngBounds(); // Infos
...
function makeMap(mapDiv) {
  ...
  var input = (0,_bling__WEBPACK_IMPORTED_MODULE_1__.$)('[name="geolocate"]'); //console.log(input);
...
function searchResultsHTML(stores) {
  return stores.map(function (store) {
    return "\n        <a href=\"/store/".concat(store.slug, "\" class=\"search__result special--search\">\n        <strong>").concat(store.name, "</strong>\n        </a>\n        ");
  }).join('');
} // 
...
function typeAhead(search) {
  ...
  var searchResults = search.querySelector('.search__results'); //console.log(searchInput, searchResults);
  ...
  searchInput.on('input', function () {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/search?q=".concat(this.value)).then(function (res) {
      ...
      if (res.data.length) {
        ...
        var html = dompurify__WEBPACK_IMPORTED_MODULE_1___default().sanitize(searchResultsHTML(res.data)); //console.log(html);

        searchResults.innerHTML = html;
        return;
      } else {
        searchResults.innerHTML = dompurify__WEBPACK_IMPORTED_MODULE_1___default().sanitize("\n                    <div class=\"search__result\">No Results for ".concat(_this.value, " found !</div>"));
      }
    }).catch(function (err) {
      console.error(err);
    });
  ...
  searchInput.on('keyup', function (e) {
    ...
    var next; //console.log("keycode", e.keyCode)
...
(0,_modules_map__WEBPACK_IMPORTED_MODULE_4__["default"])((0,_modules_bling__WEBPACK_IMPORTED_MODULE_1__.$)('#map')); // ajaxHeart( )

var heartForms = (0,_modules_bling__WEBPACK_IMPORTED_MODULE_1__.$$)('form.heart'); //console.log(heartForm);
